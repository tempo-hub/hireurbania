...
export const metadata = {
  ...
  description:
    "Book ultra-luxury Force Urbania Tempo Traveller across India (Delhi, Noida, Gurugram, Indore, Ujjain, Jaipur, Rishikesh & 100+ routes). Premium 9, 12, 16, 17 & 20 seater variants with pushback recliners & air suspension.",
  keywords: [
    "hire urbania",
  ...
  openGraph: {
    ...
    description:
      "Experience premium luxury travel with Force Urbania. 9 to 20 seater variants available for outstation, hill stations, and pilgrimage trips across India.",
  ...
  twitter: {
    ...
    title: "Hire Force Urbania Tempo Traveller | Luxury Travel India",
    description:
      "Book ultra-luxury Force Urbania Tempo Traveller (9, 12, 16, 17, 20 seaters) with air suspension, pushback leather seats & certified drivers.",
